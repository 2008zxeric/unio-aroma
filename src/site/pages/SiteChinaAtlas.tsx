  ...
  features: [
    {
      ...
      geometry: {
        type: 'Polygon',
        coordinates: [[
          [73.5, 39.5], [80.5, 42.5], [87.5, 49.0], [97.5, 50.0], [108.5, 53.5],
          [124.0, 53.5], [135.0, 48.5], [134.0, 42.5], [130.5, 39.5], [124.5, 40.0],
          [122.0, 36.5], [121.0, 31.5], [121.5, 28.0], [119.5, 25.0], [118.0, 24.5],
          [116.5, 22.5], [114.5, 22.0], [113.5, 22.5], [110.5, 21.0], [108.5, 21.5],
          [106.5, 22.0], [105.0, 23.0], [103.0, 22.5], [101.0, 21.5], [97.5, 24.5],
          [97.0, 28.5], [88.5, 28.0], [85.0, 32.0], [78.5, 35.5], [73.5, 39.5]
        ]]
      }
    }
  ]
