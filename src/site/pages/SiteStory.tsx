...
const ASSETS = {
  ...
  logo: 'https://raw.githubusercontent.com/2008zxeric/unio-aroma/feature/supabase/assets/brand/logo.svg',
};
    ...
    <div className="min-h-screen bg-white selection:bg-[#D75437] selection:text-white overflow-x-hidden">
      ...
      <section className="h-screen relative flex flex-col items-center justify-center text-center px-6">
        ...
        <div className="relative z-10 space-y-8 md:space-y-12 max-w-5xl">
          ...
          <h1 className="text-6xl md:text-[12rem] font-bold text-black tracking-[0.1em] leading-none">
            廿载寻香<br /><span className="text-black/20">元于一息</span>
          </h1>
          <div className="h-px w-32 bg-black/10 mx-auto my-6 md:my-10" />
          <div className="overflow-visible px-4">
            <p className="text-xl sm:text-2xl md:text-5xl text-black/80 tracking-[0.2em] max-w-full mx-auto font-medium whitespace-nowrap">
              从极境撷取芳香，因世界元于一息。
            </p>
          </div>
          <p className="text-xs md:text-2xl text-black/40 tracking-widest max-w-3xl mx-auto leading-loose pt-4">
        ...
        <div className="absolute bottom-16 left-1/2 -translate-x-1/2 flex flex-col items-center gap-4 text-[#D75437]/40">
          ...
          <ArrowRight className="animate-bounce rotate-90" size={20} />
        </div>
      </section>
      ...
      <section className="py-48 md:py-80 px-6 md:px-24 max-w-[1920px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-24 items-center">
          <div className="lg:col-span-7 space-y-16">
            ...
            <h2 className="text-5xl md:text-9xl font-bold text-[#2C3E28] leading-tight tracking-tighter">
              始于西南，<br />廿载寻香之路。
            </h2>
            <div className="space-y-12 text-black/60 text-lg md:text-3xl leading-loose max-w-4xl">
              <p>
          ...
          <div className="lg:col-span-5 relative group">
            ...
            <div className="absolute -bottom-12 -right-12 w-48 h-48 bg-white rounded-full shadow-2xl flex flex-col items-center justify-center p-8 border border-black/5 z-20">
              <Globe size={40} className="text-[#D4AF37] mb-2" />
        ...
        <div className="max-w-[1920px] mx-auto space-y-48 md:space-y-96">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 md:gap-48 items-center">
            <div className="order-2 lg:order-1 relative group">
              ...
              <div className="absolute -bottom-16 -right-16 w-72 h-72 bg-[#1a1a1a] rounded-full p-12 shadow-3xl flex flex-col items-center justify-center text-center border-4 border-white z-20 group-hover:scale-105 transition-transform duration-700">
                ...
                <span className="text-3xl font-bold text-white tracking-widest">Eric</span>
              </div>
            </div>
            <div className="order-1 lg:order-2 space-y-12">
              ...
              <h3 className="text-5xl md:text-9xl font-bold text-[#2C3E28] leading-tight">在行走中感知，<br />追寻本源。</h3>
              <p className="text-xl md:text-4xl text-black/60 leading-relaxed italic border-l-8 border-black/5 pl-10 py-4">
                &ldquo;我在全球 85 个极境行走，只为在稀薄的空气中，捕捉那一抹未被现代工业驯化的野性香气。&rdquo;
              </p>
              <p className="text-base md:text-2xl text-black/40 tracking-widest max-w-3xl mx-auto leading-loose pt-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 md:gap-48 items-center">
            <div className="space-y-12">
              ...
              <h3 className="text-5xl md:text-9xl font-bold text-[#1C39BB] leading-tight">将极境美学，<br />融入日常呼吸。</h3>
              <p className="text-xl md:text-4xl text-black/60 leading-relaxed italic border-l-8 border-black/5 pl-10 py-4">
            ...
            <div className="relative group">
              ...
              <div className="absolute -top-16 -left-16 w-72 h-72 bg-white rounded-full p-12 shadow-3xl flex flex-col items-center justify-center text-center border-4 border-[#1C39BB]/10 z-20 group-hover:scale-105 transition-transform duration-700">
                ...
                <span className="text-3xl font-bold text-black tracking-widest">Alice</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="pb-80 px-6">
        <div className="max-w-[1400px] mx-auto p-20 md:p-40 rounded-[6rem] bg-[#1a1a1a] text-white text-center space-y-20 shadow-[0_80px_150px_-30px_rgba(0,0,0,0.5)] overflow-hidden relative group">
          ...
          <div className="relative z-10 space-y-16">
            <Quote size={80} className="mx-auto text-[#D4AF37] opacity-60" />
            <div className="space-y-6">
              <h3 className="text-5xl md:text-[10rem] font-bold tracking-[0.1em] text-white/95 leading-none">元于一息</h3>
              <p className="text-sm md:text-3xl text-white/40 tracking-widest uppercase">Origin · Sanctuary · Breath</p>
            </div>
            <button
