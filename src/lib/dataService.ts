...
export const supabaseAdmin = createClient(
  ...
  'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inh1aWNqeWRndG9sdGRoa2Jxb2p1Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3NTUzMjY2OCwiZXhwIjoyMDkxMTA4NjY4fQ.PrfPpjQH0pWxzUUVqooXui1f3avjexLNsMPlj6CtvUQ',
  {
    auth: {
      ...
      storageKey: 'sb-xuicjydgtoltdhkbqoju-auth-token-admin',
    },
  }
);

export async function initDatabaseSchema() {
  // Schema is stable — columns already exist in production.
  // Skip all exec_sql RPC calls (which don't exist) and their noisy fallback inserts.
  console.log('Schema init skipped (columns already exist)');
}
