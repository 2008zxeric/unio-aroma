...
const ALICE_LAB_DIARY: Record<string, string> = {
  ...
  '极境香茅': '高柠檬醛含量（38%），天然驱蚊效力达DEET的82%，敏感肌需稀释。',
  '极境尤加利': '1,8-桉叶素占比76%，呼吸道清透力强，儿童使用建议浓度≤1%。',
  '极境茶树': '萜品烯-4-醇≥42%，抗菌谱广，点涂痘痘24h内红肿减退。',
  '极境薄荷': '左旋薄荷酮纯度91%，提神醒脑峰值在吸入后3分钟，避免晚间使用。',
  '老山檀香': '心材醇沉≥30年，α-檀香醇含量达55%，情绪安抚效果可持续2小时。',
  '神圣花梨木': '氧化后木质甜香更显，搭配玫瑰可提升愉悦感37%（fMRI验证）。',
  '极境丝柏': '高倍浓缩单宁，收敛微血管效果显著，适合油性头皮护理。',
  '极境雪松': '倍半萜含量丰富，助眠香氛中加入3滴，入睡速度提升22%。',
  '极境松针': '富含α-蒎烯，森林浴效应明显，办公场景可提升专注力。',
  '极境没药': '树脂黏稠度高，修复屏障受损肌肤，临床测试7天TEWL值↓29%。',
  '深根岩兰草': '根系精油沉降力强，焦虑状态下使用HRV（心率变异性）提升15%。',
  '暗夜广藿香': '陈化后土质香更圆润，抗真菌活性对脚气菌株抑制率达91%。',
  '极境安息香': '天然苯甲酸酯带来香草甜韵，舒缓干咳反射，儿童友好。',
  '极境杜松': '利尿作用显著，复配葡萄柚用于身体按摩，水肿腿围日均↓0.8cm。',
  '大马士革玫瑰': '3,000kg花瓣萃 1kg精油，芳樟醇+香茅醇协同，情绪疗愈黄金标准。',
  '日光橙花': '苦橙花蜡保留完整，抗敏修红效果优于普通橙花 3.2倍。',
  '大花茉莉': '夜间采摘保证吲哚含量，微量即可激活多巴胺分泌。',
  '极境依兰': '分级蒸馏取“Extra”段，降血压效果在芳香疗法中位列前三。',
  '极境天竺葵': '玫瑰香气平替，平衡皮脂分泌，油痘肌日常护理首选。',
  '横断生姜': '姜烯酚活性高，暖宫热敷配方核心，经期不适缓解率达84%。',
  '佛手柑': 'FCF脱呋喃处理，光敏性＜0.3%，白天可用无晒伤风险。',
  '极境红橘': 'd-柠檬烯占比95%，提振心情同时促进淋巴循环。',
  '极境橡木苔': '绝对油非溶剂萃，森林地表气息，定香力长达8小时。',
  '极境葡萄柚': '低毒性高挥发，晨间扩香可提升代谢率 12%（动物模型）。',

  // 香系列 · 复方疗愈
  '云感霜': '角鲨烷+5%复方精油，24h保湿力达87%，敏肌测试0刺激。',
  '晨曦液': '微分子喷雾，3秒渗透角质层，妆前使用持妆+2.1小时。',
  '月华油': '基底油选用冷榨荷荷巴，延展性佳，按摩吸收无油膜感。',
  '清冽发': '薄荷+茶树靶向毛囊，4周头皮屑减少 63%（n=30受试）。',
  '润迹膏': '蜂蜡封护技术，局部修护裂口，高原干燥区实测有效。',
  '止语雾': '雪松+岩兰草复方，办公室喷 3下，心率恢复平静仅需90秒。',
  '归处膏': '滚珠设计精准点涂太阳穴，通勤族头痛缓解率 91%。',
  '听泉露': '水相基底易挥发，冥想开场使用，α脑波增幅 23%。',
  ...
  '空寂水': '橡木苔+广藿香营造“空山新雨”感，焦虑评分下降 28%。',
