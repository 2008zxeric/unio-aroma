...
// 极境天竺葵: 路径需匹配 Geranium%20Rosé.webp
...
// 芳香链: 路径 Necklace%20.webp; 存香瓶: 路径 Vessel.webp
...
addD('w_ar','阿根廷','ARGENTINA','美洲/大洋洲',5, getDestAsset('Argentina'), 'arrived', false, '', '潘帕斯极境：柠檬、马黛茶');
addD('w_eg','埃及','EGYPT','非洲',2, getDestAsset('Egypt'), 'arrived', false, '', '尼罗河寻踪：茉莉、没药');
addD('w_ht','海地','HAITI','美洲/大洋洲',3, getDestAsset('Haiti'), 'arrived', false, '', '顶级岩兰草产区');
addD('w_hk','中国香港','HONG KONG','亚洲',18, getDestAsset('Hongkong'), 'arrived', false, '', '维港极境：调香贸易枢纽');
addD('w_ir','伊朗','IRAN','亚洲',2, getDestAsset('Iran'), 'arrived', false, '', '藏红花、极品玫瑰');
addD('w_ke','肯尼亚','KENYA','非洲',2, getDestAsset('Kenya'), 'arrived', false, '', '茶油、蜡菊');
addD('w_lu','卢森堡','LUXEMBOURG','欧洲',1, getDestAsset('Luxembourg'), 'arrived', false, '', '中欧芳香草本');
addD('w_mg','马达加斯加','MADAGASCAR','非洲',4, getDestAsset('Madagascar'), 'arrived', false, '', '依兰、香草、丁香');
addD('w_my','马来西亚','MALAYSIA','亚洲',13, getDestAsset('Malaysia'), 'arrived', false, '', '顶级沉香、安息香');
addD('w_mx','墨西哥','MEXICO','美洲/大洋洲',4, getDestAsset('Mexico'), 'arrived', false, '', '莱姆、香草');
addD('w_mc','摩纳哥','MONACO','欧洲',1, getDestAsset('Monaco'), 'arrived', false, '', '极奢香氛之窗');
addD('w_kp','朝鲜','NORTH KOREA','亚洲',1, getDestAsset('North Korea'), 'arrived', false, '', '极北高寒特色本草');
addD('w_pl','波兰','POLAND','欧洲',5, getDestAsset('Poland'), 'arrived', false, '', '东欧冷冽草本');
addD('w_sg','新加坡','SINGAPORE','亚洲',2, getDestAsset('Singapore'), 'arrived', false, '', '东南亚芳香核心');
addD('w_es','西班牙','SPAIN','欧洲',1, getDestAsset('Spain'), 'arrived', false, '', '苦橙、迷迭香');

// 其余使用 Unsplash 或维持现状的国家
addD('w_thai','泰国','THAILAND','亚洲',40,'https://images.unsplash.com/photo-1528127269322-539801943592?q=80&w=1200', 'arrived');
addD('w_india','印度','INDIA','亚洲',3,'https://images.unsplash.com/photo-1514222134-b57cbb8ce073?q=80&w=1200', 'arrived');
addD('w_japan','日本','JAPAN','亚洲',2,'https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?q=80&w=1200', 'arrived');
addD('w_id','印尼','INDONESIA','亚洲',12,'https://images.unsplash.com/photo-1537996194471-e657df975ab4?q=80&w=1200', 'arrived');
addD('w_uae','阿联酋','UAE','亚洲',12,'https://images.unsplash.com/photo-1512453979798-5ea266f8880c?q=80&w=1200', 'arrived');
addD('w_vn','越南','VIETNAM','亚洲',6,'https://images.unsplash.com/photo-1528127269322-539801943592?q=80&w=1200', 'arrived');
addD('w_kz','哈萨克斯坦','KAZAKHSTAN','亚洲',4,'https://images.unsplash.com/photo-1542273917363-3b1817f69a2d?q=80&w=1200', 'arrived');
addD('w_jo','约旦','JORDAN','亚洲',2,'https://images.unsplash.com/photo-1547234935-80c7145ec969?q=80&w=1200', 'arrived');
addD('w_mac','中国澳门','MACAU','亚洲',2,'https://images.unsplash.com/photo-1563245372-f21724e3856d?q=80&w=1200', 'arrived');
addD('w_kr','韩国','SOUTH KOREA','亚洲',1,'https://images.unsplash.com/photo-1517154421773-0529f29ea451?q=80&w=1200', 'arrived');
addD('w_kh','柬埔寨','CAMBODIA','亚洲',1,'https://images.unsplash.com/photo-1500048993953-d23a436266cf?q=80&w=1200', 'arrived');
...
addD('w_tr','土耳其','TURKEY','欧洲',8,'https://images.unsplash.com/photo-1524231757912-21f4fe3a7200?q=80&w=1200', 'arrived');
addD('w_fr','法国','FRANCE','欧洲',5,'https://images.unsplash.com/photo-1499002238440-d264edd596ec?q=80&w=1200', 'arrived');
addD('w_de','德国','GERMANY','欧洲',4,'https://images.unsplash.com/photo-1467269204594-9661b134dd2b?q=80&w=1200', 'arrived');
addD('w_it','意大利','ITALY','欧洲',2,'https://images.unsplash.com/photo-1523906834658-6e24ef2386f9?q=80&w=1200', 'arrived');
addD('w_at','奥地利','AUSTRIA','欧洲',2,'https://images.unsplash.com/photo-1527668752968-14dc70a27c95?q=80&w=1200', 'arrived');
addD('w_dk','丹麦','DENMARK','欧洲',2,'https://images.unsplash.com/photo-1513622470522-26c3c8a854bc?q=80&w=1200', 'arrived');
addD('w_hu','匈牙利','HUNGARY','欧洲',2,'https://images.unsplash.com/photo-1516306580123-e6e52b1b7b5f?q=80&w=1200', 'arrived');
addD('w_nl','荷兰','NETHERLANDS','欧洲',1,'https://images.unsplash.com/photo-1468436385273-8abca6dfd8d3?q=80&w=1200', 'arrived');
...
addD('w_za','南非','SOUTH AFRICA','非洲',12,'https://images.unsplash.com/photo-1516026672322-bc52d61a55d5?q=80&w=1200', 'arrived');
addD('w_zw','津巴布韦','ZIMBABWE','非洲',1,'https://images.unsplash.com/photo-1516426122078-c23e76319801?q=80&w=1200', 'arrived');
addD('w_ma','摩洛哥','MOROCCO','非洲',0,'https://images.unsplash.com/photo-1539020140153-e479b8c22e70?q=80&w=1200', 'locked');
addD('w_us','美国','USA','美洲/大洋洲',7,'https://images.unsplash.com/photo-1485738422979-f5c462d49f74?q=80&w=1200', 'arrived');
addD('w_br','巴西','BRAZIL','美洲/大洋洲',8,'https://images.unsplash.com/photo-1483728642387-6c3bdd6c93e5?q=80&w=1200', 'arrived');
