  ...
  return (
    <div className="min-h-screen relative bg-[#F5F5F5] pb-32 overflow-x-hidden selection:bg-[#D75437] selection:text-white">
      ...
      <button
        ...
        className="fixed top-4 right-4 z-[1000] px-3 py-1.5 bg-black/80 text-white text-xs rounded-full hover:bg-black"
      >
        {view === 'admin' ? '返回前台' : '⚙️ 后台'}
      </button>
          ...
          <div className="max-w-4xl mx-auto p-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-8">
              <div className="p-6 border rounded-lg">
                ...
                <div className="font-bold">产品管理</div>
                <div className="text-gray-500">{Object.keys(DATABASE).length} 个产品</div>
              </div>
              <div className="p-6 border rounded-lg">
                <div className="text-4xl mb-2">🌍</div>
                <div className="font-bold">国家管理</div>
                <div className="text-gray-500">{Object.keys(DESTINATIONS).length} 个国家</div>
              </div>
              <div className="p-6 border rounded-lg">
                <div className="text-4xl mb-2">📝</div>
                <div className="font-bold">内容编辑</div>
                <div className="text-gray-500">待开发</div>
              </div>
              <div className="p-6 border rounded-lg">
                <div className="text-4xl mb-2">📢</div>
                <div className="font-bold">广告管理</div>
                <div className="text-gray-500">待开发</div>
              </div>
              <div className="p-6 border rounded-lg">
                <div className="text-4xl mb-2">📧</div>
                <div className="font-bold">询单管理</div>
                <div className="text-gray-500">待开发</div>
              </div>
              <div className="p-6 border rounded-lg">
                <div className="text-4xl mb-2">🖼️</div>
                <div className="font-bold">素材库</div>
                <div className="text-gray-500">待开发</div>
              </div>
            </div>
            ...
            <div className="border-t pt-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="p-4 bg-gray-50 rounded">
                  <div className="text-sm text-gray-500">产品系列</div>
                  <div className="text-2xl font-bold">5</div>
                </div>
                <div className="p-4 bg-gray-50 rounded">
                  <div className="text-sm text-gray-500">产品总数</div>
                  <div className="text-2xl font-bold">{Object.keys(DATABASE).length}</div>
                </div>
                <div className="p-4 bg-gray-50 rounded">
                  <div className="text-sm text-gray-500">国家/地区</div>
                  <div className="text-2xl font-bold">{Object.keys(DESTINATIONS).length}</div>
                </div>
                <div className="p-4 bg-gray-50 rounded">
            ...
            <div className="border-t pt-8 mt-8">
              <h2 className="text-xl font-bold mb-4">🧪 技术信息</h2>
              <div className="bg-gray-100 p-4 rounded text-sm">
                <p><strong>当前数据源：</strong>静态数据 (constants.tsx)</p>
                <p><strong>Supabase：</strong>已连接，待同步数据</p>
                <p><strong>版本：</strong>v2.5 静态版</p>
              </div>
            </div>

            <button
              onClick={() => setView('home')}
              className="mt-8 px-6 py-3 bg-black text-white rounded-full hover:bg-gray-800"
            >
              返回前台
            </button>
          </div>
