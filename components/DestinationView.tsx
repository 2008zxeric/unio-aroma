           ...
           <div className="grid grid-cols-2 gap-3 sm:gap-6 h-[50vh] sm:h-[80vh]">
              ...
              <div className="col-span-1 flex flex-col gap-3 sm:gap-6">
                <div 
                  ...
                  className="flex-1 rounded-[2rem] sm:rounded-[3rem] overflow-hidden shadow-xl cursor-zoom-in group border border-black/5"
                >
                  <img src={dest.memoryPhotos[1]} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" alt="Memory Small 1" />
                </div>
                <div 
                  onClick={() => setActivePhoto(dest.memoryPhotos[2])}
                  className="flex-1 rounded-[2rem] sm:rounded-[3rem] overflow-hidden shadow-xl cursor-zoom-in group border border-black/5"
                >
                  <img src={dest.memoryPhotos[2]} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" alt="Memory Small 2" />
                </div>
              </div>
           </div>
        </section>
